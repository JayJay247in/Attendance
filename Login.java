...
public class Login {
    ...
    public void loginView() {
        ...
        //----------------LOGINTEXT----------------------
        JLabel Ign = new JLabel("LOGIN");
        Ign.setForeground(Color.decode("#DEE4E7"));
        Ign.setBounds(625, 100, 350, 75);
        Ign.setFont(new Font("Times New Roman", Font.BOLD, 75));
        frame.add(Ign);
        //--------------------------------------
        ...
        login.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    int res = dbCheck(username.getText(), new String(password.getPassword()));
                    if (res == 0) {
